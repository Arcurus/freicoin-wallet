...
public final class SendCoinsFragment extends SherlockFragment
{
	...
	private void updateView()
	{
		if (paymentIntent != null)
		{
            ...
            // MIN_TX_FEE
            //String str = String.format("%s %s", amountCalculatorLink.hasAmount() ? GenericUtils.formatValue(BigInteger.valueOf(10000), 8, 0) : String.format("%.1f", 0f), CoinDefinition.coinTicker);
            String str = "demurrage";
